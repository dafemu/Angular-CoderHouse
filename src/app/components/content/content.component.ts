...
export class ContentComponent {
  estudiantes: Array<any> = [
    { "nombre": 'David', 'edad': 19, "fechaNacimiento": new Date(2014,10,12), 'calificacion': 2 },
    { "nombre": 'Danny', 'edad': 20, "fechaNacimiento": new Date(2013,11,5), 'calificacion': 3 },
    { "nombre": 'Camila', 'edad': 18, "fechaNacimiento": new Date(2015,9,22), 'calificacion': 5 },
    { "nombre": 'Jiss', 'edad': 18, "fechaNacimiento": new Date(2015,8,14), 'calificacion': 4 }
  ];
